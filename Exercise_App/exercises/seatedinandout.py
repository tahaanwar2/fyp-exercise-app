...
class Seatedinandout():
    ...
    def start_exercise(self, mp_drawing, mp_pose, col, video_path):
        ...
        with col:  # Horizontal Aline
            run = st.checkbox('SeatedInOut', key='seatedinandout')
            ...
            while cap.isOpened() and run:
                ...
                if ret:
                    ...
                    try:
                        ...
                        if left_position_angle < 50 and right_position_angle < 50 and left_angle < 30 and right_angle < 30 and (left_wrist_position_angle < 30 or right_wrist_position_angle < 30):
                            self.up = True
                        if left_position_angle > 50 and right_position_angle > 50 and (left_wrist_position_angle > 30 or right_wrist_position_angle > 30) and self.up:
                            self.up = False
                            self.count += 1
                            self.calories_burned += calorie_counter("seatedinandout")
