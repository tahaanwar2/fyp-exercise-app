...
class Lunges():
    ...
    def start_exercise(self , mp_drawing , mp_pose, col, video_path):
        ...
        with col: #Horizontal Aline
            run = st.checkbox('Lunges', key='lunges')
            ...
            while cap.isOpened() and run:
                ...
                if ret:
                    ...
                    try:
                        ...
                        left_position_angle = calculate_angle(left_shoulder, left_hip, left_knee)
                        right_position_angle = calculate_angle(right_shoulder, right_hip, right_knee)
                        ...
                        #             tuple(np.multiply(left_hip, [h, w]).astype(int)), 
                        ...
                        if left_angle<90 and right_position_angle>140 and self.left_right==False:
                            self.left_right = True
                            self.count+=1
                            self.calories_burned += calorie_counter("lunges")                          
                        
                        if right_angle<90 and left_position_angle>140 and self.left_right==True:
