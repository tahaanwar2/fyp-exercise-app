...
class Dumbbelpress():
    ...
    def start_exercise(self, mp_drawing, mp_pose, col, video_path):
        ...
        with col:  # Horizontal Aline
            run = st.checkbox('DumbbelPress', key='dumbbelpress')
            ...
            while cap.isOpened() and run:
                ...
                if ret:
                    ...
                    try:
                        ...
                        parallel = calculate_angle(
                            right_wrist, nose, left_wrist)
                        ...
                        # Visualize angle
                        cv2.putText(self.image, "Parallel: " + str(parallel),
                        ...
                        if left_angle > 140 and right_angle > 140 and parallel < 40:
                            self.up = True
                        if parallel > 100 and self.up:
                            self.up = False
                            self.count += 1
                            self.calories_burned += calorie_counter(
                                "dumbbelpress")
