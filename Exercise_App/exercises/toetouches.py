...
class Toetouches():
    ...
    def start_exercise(self, mp_drawing, mp_pose, col, video_path):
        ...
        with col:  # Horizontal Aline
            run = st.checkbox('Toetouches', key='toetouches')
                ...
                if ret:
                    ...
                    try:
                        ...
                        left_angle = calculate_angle(
                            left_wrist, left_hip, left_ankle)
                        right_angle = calculate_angle(
                            right_wrist, right_hip, right_ankle)
                        ...
                        if left_position_angle < 110 and right_position_angle < 110 and left_angle < 20 and right_angle < 20:
                            self.up = True
                        if left_position_angle < 110 and right_position_angle < 110 and left_angle > 20 and right_angle > 20 and self.up:
                            self.up = False
                            self.count += 1
                            self.calories_burned += calorie_counter("toetouches")
